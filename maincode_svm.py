...
def predct(val):
	...
	y_pred = clf_gini.predict(val)

	return y_pred


print("Predicted Output",predct([[40,0,0,140,289,0,0,172,0,0,0]]))
# print("Predicted Output",predct([[40.0,0.0,0.0,140.0,289.0,0.0,0.0,172,0.0,0,0.0]]))