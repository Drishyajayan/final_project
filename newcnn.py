...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'D:\project\src\static\ECG_Image_data\train')
    i=-1
    for pa in my_list:

        print(pa,"==================")
        i=i+1
        for root, dirs, files in os.walk(r'D:\project\src\static\ECG_Image_data\train\\' + pa):

         for f in files:
            file_path = os.path.join(r'D:\project\src\static\ECG_Image_data\train\\'+pa, f)
...
# # load dataset
# x_dataset, y_dataset = read_dataset(r"D:\project\src\static\train")
# X_train, X_test, y_train, y_test = train_test_split(x_dataset, y_dataset, test_size=0.2)
#
# y_train1=[]
# for i in y_train:
#     res = keras.utils.to_categorical(i, num_classes)
#     print(i,res)
#     y_train1.append(res)
#
# y_train=y_train1
...
# # ------------------------------
#
# if not os.path.exists("model21.h5"):
#
...
def predict_cnn(fn):
    ...
    dataset=dataset/255
    mo = load_model(r"D:\project\src\model11.h5")
...
# print(predict_cnn(r"D:\project\src\static\ECG_Image_data\test\S\S16.png"))